...
<div class="<?php echo $block['container']; ?>">
    ...
    <?php if( $block['image_side'] === 'left' ) : ?>
        <div class="block block-image-text-odd block-image-text row align-items-center" style="--bg-color: <?php echo esc_attr( $block['background_color'] ); ?>">
    ...
    <?php else : ?>
        <div class="block block-image-text-even block-image-text row align-items-center" style="--bg-color: <?php echo esc_attr( $block['background_color'] ); ?>">
            <div class="col-12 col-lg-7 text-start p-5">
                <?php echo $block['text']; ?>
                <?php if( $block['use_button'] ) : ?>
                    <div class="mt-4">
