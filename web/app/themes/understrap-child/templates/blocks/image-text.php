...
<div class="<?php echo $block['container']; ?>">
    ...
    <?php if( $block['image_side'] === 'left' ) : ?>
        <div class="block block-image-text-odd block-image-text row gy-5 align-items-<?php echo $block['vertical_align']; ?>" style="--bg-color: <?php echo esc_attr( $block['background_color'] ); ?>">
